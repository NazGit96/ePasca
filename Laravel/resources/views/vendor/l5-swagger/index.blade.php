...
window.onload = function() {
  ...
  (function () {
    ...
    setTimeout(function () {
        const BEARER_TOKEN = 'swagger_epb_bearer_token';
        const bearerToken = window.localStorage.getItem(BEARER_TOKEN);
        if (bearerToken) {
        ...
        window.localStorage.setItem(BEARER_TOKEN, payload.bearerAuth.value);
