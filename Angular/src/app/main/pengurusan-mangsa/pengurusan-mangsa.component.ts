import { Component, OnInit, ViewChild, ViewEncapsulation, OnChanges, SimpleChanges } from '@angular/core';
...
export class PengurusanMangsaComponent implements OnInit{
	...
	////////////////////////////
	filterOptions = [
		{ search_label: 'Covid Kematian', search_value: 'Kematian' },
		{ search_label: 'Covid RM100', search_value: 'Covid100' },
		{ search_label: 'BWI', search_value: 'BWI' },
		// { search_label: 'BWI Kematian', search_value: 'BWIKematian' },
	];
	...
	ngOnInit(): void {
		...
		this.terms$.pipe(
			...
			/////////////////////////////////
			console.log('ngOnInit filterValue:', filterValue);
